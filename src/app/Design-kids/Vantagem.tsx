    ...
    <div className={styles.all}>
      <div className={styles.container}>
        ...
        <div className={styles.info}>
          ...
          <h2>(1h / semana)</h2>
          <h2>(a partir dos 8 aos 11 anos de idade)</h2>
          <h2>Centro - Mensalidade: R$145,00 + R$85,00 da matrícula</h2>
          <h2>Itaipava - Mensalidade: R$180,00 + R$85,00 da matrícula</h2>
